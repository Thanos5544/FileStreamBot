...
class Telegram:
    ...
    START_PIC = env.get('START_PIC', "https://graph.org/file/17664c863149c144dc35a-7e59307701f8651b77.jpg")
...
class Server:
    ...
    URL = "https://annual-carin-patrickbotz-382049fb.koyeb.app/".format(
